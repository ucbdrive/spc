...
class PRED(nn.Module):
    def __init__(self, classes, num_actions):
        ...
        self.action_encoder7.weight.data.normal_(0, math.sqrt(2. / (classes*1*1)))
        # self.action_encoder7.weight.data[:] += 1 / (64*5*5)

    def single_forward(self, x, action):
        y1 = self.action_encoder1(action).view(16, self.classes, 5, 5)
        ...
        y7 = self.action_encoder7(action).view(self.classes, 64, 1, 1)
