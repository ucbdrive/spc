...
class convLSTM(nn.Module):
    def __init__(self, in_channels, feature_channels):
        ...
        self.cell_1 = convLSTMCell(in_channels, feature_channels, 3, stride = 1, padding = 2, dilation = 2)
        self.cell_2 = convLSTMCell(in_channels, feature_channels, 5, stride = 1, padding = 2)
        # self.cell_3 = convLSTMCell(in_channels, feature_channels, 3, stride = 1, padding = 2, dilation = 2)
