...
class Memory(object):
    def __init__(self, limit, action_shape, observation_shape):
        ...
        self.speed = RingBuffer(limit, shape=(1,))
    ...
    def sample(self, batch_size):
        ...
        speed_batch = self.speed.get_batch(batch_idxs)
        ...
        result = {
            ...
            'speed': array_min2d(speed_batch),
            'terminals1': array_min2d(terminal1_batch),
        }
        return result

    def append(self, obs0, action, reward, obs1, terminal1, speed, training=True):
        if not training:
            return
