def init_parser(parser):
    ...
    parser.add_argument('--uncertain-xyz', default=True)
    parser.add_argument('--uncertain-action', default=True)
    parser.add_argument('--uncertain-pos', default=True)
    parser.add_argument('--uncertain-angle', default=True)
    parser.add_argument('--uncertain-speed', default=True)
    parser.add_argument('--uncertain-buffer-size', type=int, default=10000)
    parser.add_argument('--uncertainty-update-freq', type=int, default=10)
