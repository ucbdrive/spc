...
# import dla_up
# import sedla_up as dla_up
# import sedla_up_cabrrb as dla_up
        ...
        if i % print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'Score {score:.2f}'.format(
                      ...
                      data_time=data_time, loss=losses, score=round(np.nanmean(per_class_iu(hist)) * 100, 2)))
...
def train_seg(args):
    ...
    if 'se' in args.arch and 'cr' in args.arch and 'lk' in args.arch:
        import sedla_up_lkcr as dla_up
    elif 'se' in args.arch and 'cr' in args.arch:
        import sedla_up_cr as dla_up
    elif 'se' in args.arch and 'ps' in args.arch:
        import sedla_up_ps as dla_up
    elif 'se' in args.arch and 'lk' in args.arch:
        import sedla_up_lk as dla_up
    elif 'gc' in args.arch and 'bn' in args.arch:
        import dla_up_gc_bn as dla_up
    elif 'se' in args.arch:
        import sedla_up as dla_up
    elif 'lk' in args.arch:
        import dla_up_lk as dla_up
    elif 'cr' in args.arch:
        import dla_up_cr as dla_up
    elif 'gc' in args.arch:
        import dla_up_gc as dla_up
    elif 'bn' in args.arch:
    ...
    model = dla_up.__dict__.get(args.arch)(
