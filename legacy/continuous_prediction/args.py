def init_parser(parser):
    ...
    parser.add_argument('--use-xyz', type = bool, default = True, metavar = 'XYZ', help = 'use segmentation')
    parser.add_argument('--use-dqn', type = bool, default = True, metavar = 'D', help = 'use DQN')
    parser.add_argument('--use-center-dist', type = bool, default = False, metavar = 'CD', help = 'use center distance')
    ...
    parser.add_argument('--collect-steps', type = int, default = 500, metavar = 'CS', help = 'steps of data collection in each epoch')
    ...
    parser.add_argument('--action-dim', type = int, default = 2, metavar = 'NA', help = 'continuous action space dimension')
    parser.add_argument('--num-steps', type = int, default = 12, metavar = 'NS', help = 'number of prediction steps')
    parser.add_argument('--batch-size', type = int, default = 16, metavar = 'BS', help = 'batch size')
    parser.add_argument('--buffer-size', type = int, default = 10000, metavar = 'BUS', help = 'buffer size')
    parser.add_argument('--action-batch-size', type = int, default = 120, metavar = 'ABS', help = 'action batch size')
