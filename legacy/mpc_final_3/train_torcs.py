...
if __name__ == '__main__':
    ...
    # For jfc
    if os.path.exists('/root/pyTORCS/game_config/michigan.xml'):
        args.game_config = '/root/pyTORCS/game_config/michigan.xml'
    # args.game_config = '/home/qizhicai/git_spn/pyTORCS/game_config/michigan.xml' 
