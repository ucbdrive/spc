...
class global_convolution(nn.Module):
    ...
    def __init__(self, c, o, lk, sk):
        ...
        self.br = BoundaryRefinement(o, o, sk)
...
class IDAUp(nn.Module):
    ...
    def __init__(self, large_kernel, small_kernel, out_dim, channels, up_factors):
        ...
        for i in range(1, len(channels)):
            ...
            #     BatchNorm(out_dim),
            #     nn.ReLU(inplace=True))
            node = global_convolution(out_dim * 2, out_dim, large_kernel, small_kernel)
...
def sedla34up_lk(classes, pretrained_base=None, **kwargs):
    model = DLASeg('dla34', classes, pretrained_base='sedla34.pth', **kwargs)
    return model


# def dla60up_lk(classes, pretrained_base=None, **kwargs):
#     model = DLASeg('dla60', classes, pretrained_base=pretrained_base, **kwargs)
#     return model


# def dla102up_lk(classes, pretrained_base=None, **kwargs):
#     model = DLASeg('dla102', classes,
#                    pretrained_base=pretrained_base, **kwargs)
#     return model


# def dla169up_lk(classes, pretrained_base=None, **kwargs):
