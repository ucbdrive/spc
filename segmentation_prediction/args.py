def init_parser(parser):
    ...
    parser.add_argument('--pos-rescale', type = float, default = 1/7, metavar = 'PR', help = 'trackPos rescale to [-1, 1]')
    parser.add_argument('--angle-rescale', type = float, default = 2, metavar = 'AR', help = 'angle rescale')
    ...
    parser.add_argument('--loss-decay', type = float, default = 0.97, metavar = 'LD', help = 'loss weight decay rate')