def init_parser(parser):
    ...
    parser.add_argument('--angle-rescale', type = float, default = 1.5, metavar = 'AR', help = 'angle rescale')
    ...
    parser.add_argument('--exploration-decay', type = float, default = 0.9999, metavar = 'ED', help = 'exploration decay rate')
    parser.add_argument('--loss-decay', type = float, default = 0.87, metavar = 'LD', help = 'loss weight decay rate')
    parser.add_argument('--safe-pos', type = float, default = 2, metavar = 'SP', help = 'safe pos for naive driver')
    parser.add_argument('--safe-angle', type = float, default = 0.5, metavar = 'SA', help = 'safe angle for naive driver')