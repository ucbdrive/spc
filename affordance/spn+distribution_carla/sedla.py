...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, reduction=16):
...
class DLA(nn.Module):
    ...
    def __init__(self, levels, channels, num_classes=1000,
        ...
        self.avgpool = nn.AdaptiveAvgPool2d(1)  # nn.AvgPool2d(pool_size)
    ...
    def load_pretrained_model(self, data_name, name):
        if data_name.endswith('.pth'):
            model_weights = torch.load(data_name)
